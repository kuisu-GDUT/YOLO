...
train_annotation_dir = r"E:\kuisu\Datasets\DLH101\V1\my_yolo_dataset\train\labels"
val_annotation_dir = r"E:\kuisu\Datasets\DLH101\V1\my_yolo_dataset\val\labels"
...
def change_and_create_cfg_file(classes_info, save_cfg_path="./cfg/my_yolov3.cfg"):
    ...
    # this operation only deal with yolov3-spp-dlh.cfg

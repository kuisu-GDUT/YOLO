...
def showLR(epochs,scheduler,optimizer):
    # Plot lr schedule->如果取消注释,则将lr进行更新30次,
    y = []
...
def train(hyp):
    ...
    if opt.freeze_layers:
        ...
        darknet_end_layer = 0  # only yolov3spp cfg
    ...
    if weights.endswith(".pt") or weights.endswith(".pth"):
        ...
        print("weight path is invalid, {}".format(weights))
            ...
            if opt.savebest is False:
                ...
                with open(results_file, 'r') as f:
                    save_files = {
                        ...
                        'epoch': epoch,
                        'best_map': best_map}
                    torch.save(save_files, "./weights/yolov3_spp_dlh101-{}.pt".format(epoch))
            else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3-spp-dlh.cfg', help="*.cfg path")
    ...
    parser.add_argument('--weights', type=str, default='weights/yolov3_spp_dlh101-26_best.pt',

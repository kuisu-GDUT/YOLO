...
GL_NUMBBOX = 2
GL_NUMGRID = 7
STATIC_DATASET_PATH = r'E:\kuisu\Datasets\voc\VOC2012'
...
def img_augument(img_dir, save_img_dir, labels_dir):
    ...
    for img_name in imgs_list:
        ...
        if h > w:
            padw = (h - w) // 2
            img = np.pad(img, ((0, 0), (padw, padw), (0, 0)), 'constant', constant_values=0)#np.pad(array,(0,1,2),mode,constant_values=0)
        elif w > h:
            padh = (w - h) // 2

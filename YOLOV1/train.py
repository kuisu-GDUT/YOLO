...
from model import MyNet, calculate_loss
...
class TrainInterface(object):
    ...
    def __train(model, train_loader, optimizer, epoch, num_train, opts):
        ...
        for i,(imgs, labels) in enumerate(train_loader):
            ...
            loss = calculate_loss(preds,labels)  # 计算损失
...
if __name__ == '__main__':
    ...
    parser.add_argument("--epoch", type=int, default=60, help="number of end epoch")
    parser.add_argument("--start_epoch", type=int, default=27, help="number of start epoch")
    ...
    parser.add_argument("--dataset_dir", type=str, default=r"E:\kuisu\Datasets\voc\VOC2012\voc2012_forYolov1")
    parser.add_argument("--checkpoints_dir", type=str, default="./checkpoints")
    parser.add_argument("--print_freq", type=int, default=20,
                             help="print training information frequency (per n iteration)")
    parser.add_argument("--save_freq", type=int, default=1, help="save model frequency (per n epoch)")
    parser.add_argument("--num_workers", type=int, default=8, help="use n threads to read data")
    parser.add_argument("--pretrain", type=str, default=r"checkpoints/epoch60.pkl", help="pretrain model path")
    parser.add_argument("--random_seed", type=int, default=0, help="random seed for split dataset")
    ...
    #开始训练
    train_interface = TrainInterface(opts)
